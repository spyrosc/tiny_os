...
typedef struct process_control_block {
 ...
 //
  int num_threads; //posa thread exei to proccess
  rlnode PTCB_lista;//lista me ta PTCB's
  int exit_called; //An exei kalestei h sys_Exit
  CondVar Wait_others; // perimenoume ta alla thread na teleiwsoun
